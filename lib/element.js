...
/* .element(name, properties, contents)
 *
 ...
 */
Scratch.element = function(name) {
	var element = document.createElement(name);
	for(var i=1; i<arguments.length; i++) {
		var arg = arguments.item(i);
		if(arg.constructor == Array) this.addChildren(element, arg);
		else if(arg.constructor == Object) this.addProperties(element, arg);
 ...
 */
Scratch.addChildren = function(element, children) {
